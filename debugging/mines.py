...
class Minesweeper:
    ...
    def place_mines(self, first_x, first_y):
        possible_positions = [(x, y) for x in range(self.width) for y in range(self.height) if (x != first_x or y != first_y)]
        self.mines = set(random.sample(possible_positions, self.mines_count))
